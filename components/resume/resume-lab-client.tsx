...
import { Copy, FileText, GitCompare, Save, ScanSearch, Upload } from "lucide-react";
      ...
      <section className="grid gap-6 xl:grid-cols-[0.42fr_0.58fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Replace the current PDF to refresh the shared resume used across ATS, outreach, and portfolio generation.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <label className="flex cursor-pointer items-center justify-between rounded-[24px] border border-dashed border-white/15 bg-black/20 px-5 py-4 transition hover:border-primary/40 hover:bg-primary/5">
              <div className="text-left">
                <p className="font-semibold text-white">Choose PDF resume</p>
              ...
              <input className="hidden" type="file" accept=".pdf,application/pdf" onChange={handleResumeUpload} />
            </label>
